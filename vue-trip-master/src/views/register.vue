<template>
    <img src="../assets/img/utilImg/返回.png" @click="goBack()" style="width: 20px;margin-top: 10px"/>
...
const register = () => {
    console.log(user);
    axios.post("http://localhost:88/users/register", user).then(res=>{
        router.push('/login');
    })
}
</script>
...
.registration-container {
    ...
    align-items: center;
    height: 100vh;
    background-image: url('../assets/img/utilImg/login.jpg');
